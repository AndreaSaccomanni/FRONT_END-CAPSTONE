  ...
  return (
    <Container fluid className="home-container text-light">
      ...
      <section className="hero-section text-center d-flex flex-column justify-content-center align-items-center">
        <h1 className="display-3 fw-bold mt-5">Migliora il tuo benessere!</h1>
      ...
      <section className="mt-5">
        <h2 className="text-center mb-4">Cosa posso offrirti?</h2>
      ...
      <section className="text-center mt-5">
        ...
        <Button variant="warning" as={Link} to="/servizi" className="btn-lg mt-3 mb-5">
